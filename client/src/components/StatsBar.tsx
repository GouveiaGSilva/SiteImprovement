	...
	return (
		<div className="border-y border-white/10 bg-white/5 backdrop-blur-sm py-12">
			<div className="mx-auto max-w-7xl px-6 lg:px-8">
				<div className="relative overflow-hidden rounded-2xl bg-white/5 p-px shadow-lg ring-1 ring-white/10">
					<div className="absolute inset-0 bg-gradient-to-r from-green-400/20 via-emerald-500/20 to-teal-500/20 opacity-20" />
					<dl className="relative grid grid-cols-2 gap-px rounded-2xl bg-background/80 backdrop-blur-sm lg:grid-cols-4">
